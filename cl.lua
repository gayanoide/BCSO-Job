...
RegisterKeyMapping('Emybcso', 'Ouvrir le menu L.S.P.D', 'keyboard', 'F6')
...
RegisterCommand('Emybcso', function()
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bcso' then
        exports.ox_lib:showContext('bcsomenu')    
	end
end)
    ...
    options = {
        {
          ...
          onSelect = function()
            ...
            if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('bcso:handcuff', GetPlayerServerId(closestPlayer))
        ...
        },
        {
          ...
          onSelect = function()
            ...
            local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()            
            if closestPlayer ~= -1 and closestDistance <= 3.0 then
                TriggerServerEvent('bcso:drag', GetPlayerServerId(closestPlayer))
            end
          end,
        },
        {
        ...
        },
        {
          ...
          onSelect = function()
                ...
                local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                if closestPlayer ~= -1 and closestDistance <= 3.0 then
					TriggerServerEvent('bcso:putInVehicle', GetPlayerServerId(closestPlayer))
                else
        ...
        },
        {
          ...
          onSelect = function()
                ...
                local closestPlayer, closestDistance = ESX.Game.GetClosestPlayer()
                if closestPlayer ~= -1 and closestDistance <= 3.0 then
                    TriggerServerEvent('bcso:OutVehicle', GetPlayerServerId(closestPlayer))
                else
                    ESX.ShowNotification('Aucune personne proche')
                end
          end,
...
AddEventHandler('tp:openmenu', function()
    exports.ox_lib:showContext('tpbcso')
end)
    ...
    options = {
        {
            ...
            onSelect = function()
				...
				TriggerServerEvent('hbcso:Ouvert')
        ...
        },
        {
            ...
            onSelect = function()
                ...
                TriggerServerEvent('hbcso:Fermer') 
...
RegisterNetEvent('bcso:annonce')
AddEventHandler('bcso:annonce', function()
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bcso' then
...
RegisterNetEvent('bcso:armory')
AddEventHandler('bcso:armory', function()
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bcso' then
    ...
    options = {
        {
            ...
            onSelect = function()
                --ESX.ShowNotification("~y~ca fonctionne")  				
				--exports["WaveShield"]:TriggerServerEvent('hbcso:addarmes')
				TriggerServerEvent('hbcso:addarmes')
        ...
        },
        {
            ...
            onSelect = function()
                --ESX.ShowNotification("~y~ca fonctionne") 
                --exports["WaveShield"]:TriggerServerEvent('hbcso:rendarmes') 
                TriggerServerEvent('hbcso:rendarmes') 
...
AddEventHandler('bcso:handcuff', function()
...
AddEventHandler('bcso:putInVehicle', function()
...
AddEventHandler('bcso:OutVehicle', function()
    local plyPed = PlayerPedId()
...
RegisterNetEvent('bcso:drag')
AddEventHandler('bcso:drag', function(copId)
	if isHandcuffed then
...
function OpenBillingMenu()
    ...
    if player ~= -1 and distance <= 3.0 then
        ...
        if input then
            ...
            if amount then
                TriggerServerEvent('esx_billing:sendBill', target, 'society_bcso', 'Amende '..Config.pos.menu.title, amount)
