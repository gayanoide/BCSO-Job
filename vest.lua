...
RegisterCommand('Emyhelmetbcso', function()
...
RegisterNetEvent('bcso:vestmenu')
AddEventHandler('bcso:vestmenu', function(type, data)
    if ESX.PlayerData.job and ESX.PlayerData.job.name == 'bcso' then        
        exports.ox_lib:showContext('vestbcso')
    else
